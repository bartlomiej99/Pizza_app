...
from .models import Pizza, Customer, Cart, Topping, PIZZA_SIZES, OrderPizza, BillingAddress
...
class PizzaCreateView(PermissionRequiredMixin, View):
    permission_required = 'pizza_elk.add_pizza'
    ...
    def post(self, request):
        ...
        if form.is_valid():
            user = request.user
            if user.has_perm('pizza_elk.add_pizza'):
...
class PizzaDeleteView(PermissionRequiredMixin, View):
    permission_required = 'pizza_elk.delete_pizza'
    ...
    def post(self, request):
        ...
        if form.is_valid():
            user = request.user
            if user.has_perm('pizza_elk.delete_pizza'):
...
class ToppingAddView(PermissionRequiredMixin, View):
    permission_required = 'pizza_elk.add_topping'
    ...
    def post(self, request):
        ...
        if form.is_valid():
            user = request.user
            if user.has_perm('pizza_elk.add_topping'):
...
class ToppingEditView(PermissionRequiredMixin, View):
    permission_required = 'pizza_elk.change_topping'
    ...
    def post(self, request):
        ...
        if form.is_valid():
            user = request.user
            if user.has_perm('pizza_elk.change_topping'):
...
class ToppingDeleteView(PermissionRequiredMixin, View):
    permission_required = 'pizza_elk.delete_topping'
    ...
    def post(self, request):
        ...
        if form.is_valid():
            user = request.user
            if user.has_perm('pizza_elk.delete_topping'):
...
class OrdersView(PermissionRequiredMixin, LoginRequiredMixin, View):
    permission_required = 'pizza_elk.view_cart'
    permission_denied_message = "You don't have permission to see orders!"

    def get(self, request):
        user = request.user
        if user.has_perm('pizza_elk.view_cart'):
