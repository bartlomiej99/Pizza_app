...
class Topping(models.Model):
    name_topping = models.CharField(max_length=64,  verbose_name="Topping name")
    price = models.FloatField(verbose_name='Price in zł')
...
class Pizza(models.Model):
    ...
    size = models.IntegerField(choices=PIZZA_SIZES, verbose_name='Pizza size')
    price = models.FloatField(verbose_name='Pizza price in zł')
